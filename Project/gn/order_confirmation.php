...
//TEMPLATES
    ...
    while (true) {
      ...
      if ($sel == null) {
        // Unique transaction ID found
        break;
      } else {
        // Transaction ID already exists, generate a new one
        $id = rand(pow(10, 7-1), pow(10, 7)-1);
      }
    }
    ...
    while(true){
      ...
      if($sel && $sel['transaction_ID'] == $id){ // Check if $sel is not null
      ...
      <div class="w-full text-md">
          <div class='bg-white shadow sm:rounded'>
            <div class='px-4 py-5 sm:px-6'>
              <h3 class='text-lg leading-6 font-medium text-gray-900'>Order number: <?php  echo $id ?>
            </h3>
            </div>
            <div class='border-t border-gray-200'>
              <dl>
                <div class='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                    ...
                    <dd class='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'><?php echo $_SESSION['firstName'] . " " . $_SESSION['lastName'] ?></dd>
                </div>
                <div class='bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                    <dt class='text-sm font-medium text-gray-500'>Shipping address</dt>
                    <dd class='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'><?php echo $_SESSION['addressFirstLine'] ?></dd>
                    <dd class='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'><?php echo $_SESSION['addressSecondLine'] ?></dd>
                    <dd class='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'><?php echo $_SESSION['city'] . " " . $_SESSION['state'] . ", " . $_SESSION['zip'] ?></dd>
                </div>
                <div class='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                ...
                <div class='bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
                    ...
                    <dd class='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'><?php echo sprintf("%.2f", $totalPrice) ?></dd>
                </div>
                <div class='bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
